...
STOPWORDS = ['a', 'all', 'an', 'and', 'any', 'are', 'as', 'be', 'been', 'but', 'by', 'few', 'for', 'have', 'he', 'her', 'here', 
             'him', 'his', 'how', 'i', 'in', 'is', 'it', 'its', 'many', 'me', 'my', 'none', 'of', 'on', 'or', 'our', 'she', 'some', 
             'the', 'their', 'them', 'there', 'they', 'that', 'this', 'us', 'was', 'what', 'when', 'where', 'which', 'who', 'why', 
             'will', 'with', 'you', 'your']
...
class Stemmer():
    ...
    def stem(self, wordlist: list[str]) -> list[str]:
        return [self._stem(w, 0, len(w) - 1) for w in wordlist]
...
class Tokenizer():
    ...
    @staticmethod
    def casefold(text: list[str]) -> list[str]:
        return [token.casefold() for token in text]
    
    @staticmethod
    def split(text: str, delimeter = None):
...
if __name__ == "__main__":
    ...
    print(stemmer.stem("computer", 0, len("computer") - 1))
